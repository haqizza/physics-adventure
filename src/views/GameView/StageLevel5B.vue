...
const backToExperiment = () => {
  router.push({name: 'level-4', query: {next: 'level-5b'}})
}
</script>

<template>
  <ScreenBackground sky="1" color="red" ground="6">
    <div
      id="ContentWrapper"
      ...
      <div class="py-8 md:py-12 md:px-12 md:grid md:grid-cols-4">
            ...
            <table class="min-w-lg border-separate border-spacing-2 table-fixed">
              ...
              <thead>
                <tr>
                  ...
                  <th class="px-2 py-2 bg-yellow-100 text-center border-4 border-blue-300 rounded" colspan="2">Jarak Pola Difraksi (y)</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="px-2 py-2 bg-yellow-100 text-center border-4 border-blue-300 rounded font-bold text-green-600">5 m</td>
                  ...
                  <td class="w-min-xs md:px-2 md:py-2 text-center border-4 border-yellow-500 rounded">
                    <BaseInput
                      ...
                      :backgroundColor="answerCorrection.p11 && answerCorrection.p21 ? '!bg-transparent' : '!bg-red-400'"
                      labelClass="!w-0 !p-0"
                      inputClass="!w-full !p-1 !text-base text-center"
                      placeholder="0"
                    />
                ...
                <tr>
                  ...
                  <td class="px-2 py-2 bg-yellow-100 text-center border-4 border-blue-300 rounded font-bold text-green-600">7 m</td>
                  <td class="w-min-xs md:px-2 md:py-2 text-center border-4 border-blue-300 rounded">
                    <BaseInput
                      id="p12"
                  ...
                  <td class="w-min-xs md:px-2 md:py-2 text-center border-4 border-yellow-500 rounded">
                    <BaseInput
                      ...
                      :backgroundColor="answerCorrection.p12 && answerCorrection.p22 ? '!bg-transparent' : '!bg-red-400'"
                      labelClass="!w-0 !p-0"
                      inputClass="!w-full !p-1 !text-base text-center"
                      placeholder="0"
                    />
                ...
                <tr>
                  ...
                  <td class="px-2 py-2 bg-yellow-100 text-center border-4 border-blue-300 rounded font-bold text-green-600">9 m</td>
                  <td class="w-min-xs md:px-2 md:py-2 text-center border-4 border-blue-300 rounded">
                    <BaseInput
                      id="p13"
                  ...
                  <td class="w-min-xs md:px-2 md:py-2 text-center border-4 border-yellow-500 rounded">
                    <BaseInput
                      ...
                      :backgroundColor="answerCorrection.p13 && answerCorrection.p23 ? '!bg-transparent' : '!bg-red-400'"
                      labelClass="!w-0 !p-0"
                      inputClass="!w-full !p-1 !text-base text-center"
                      placeholder="0"
                    />
        ...
        <div class="flex flex-col mt-4 md:mt-0">
          <TheButton
            ...
            @click="completePhase"
          />
          <img class="w-32 md:w-64 mt-2 md:mt-18" :src="Ivory" alt="Mascot named Ivory">
        </div>
      </div>
    </div>
  </ScreenBackground>
